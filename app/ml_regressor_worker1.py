...
spark = SparkSession.builder.appName("ml_regressor_worker1").getOrCreate()

# Read from worker1's local data partition
df = spark.read.parquet("file:///data/part_2.parquet")
...
# print("=" * 50)
# print("Training MLP Small Network (64-32) on Worker1 Data")
# print("=" * 50)
...
# print("\n" + "=" * 50)
# print("Training MLP Medium Network (128-64-32) on Worker1 Data")
# print("=" * 50)
...
print("\n" + "=" * 50)
print("Training MLP Large Network (256-128-64) on Worker1 Data")
print("=" * 50)
...
results_file = "/shared/results_worker1.txt"
os.makedirs(os.path.dirname(results_file), exist_ok=True)

with open(results_file, "w") as f:
    f.write("=" * 70 + "\n")
    f.write("MULTILAYER PERCEPTRON CLASSIFIER - WORKER1 DATA (part_2.parquet)\n")
    f.write("=" * 70 + "\n\n")
    
    # Dataset Info
    f.write("DATASET INFORMATION\n")
    f.write("-" * 70 + "\n")
    f.write(f"Data source: file:///data/part_2.parquet (Worker1 local)\n")
